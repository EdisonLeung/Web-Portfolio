let resumeData = {
    ...
    "roleDescription": "I love exploring and creating new technologies. I'm always trying to find something funny in any situation",
    "socialLinks":[
        {
          "name":"linkedin",
    ...
    "aboutme":"Experienced in programming with various programming languages. Hands on experience with IOS and Android mobile app development. Seeking opportunities to pursue my passion in computer science and learn more about its applications",
    ...
    "education":[
      {
        ...
        "info":["Pursuing B.S. in Computer Science from Paul G. Allen Center for Computer Science and Engineering", "Major GPA: 3.87"],
        "courses": [
        ...
        "clubs": "Advanced Robotics (ARUW), Association for Computing Machinery (ACM), Asian American InterVarsity (AAIV)"
      }
    ],
    "work":[
      {
